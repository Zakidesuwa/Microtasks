...
<body class="bg-gray-100">
    <header class="flex justify-between items-center h-20 border-b border-gray-300 px-6 bg-white">
        <div class="flex items-center gap-4">
            <img src="/logonamin.png" alt="Logo" class="w-12 h-12" />
            <h1 class="text-2xl font-bold">Microtask Support</h1>
        </div>
        <div class="flex items-center gap-4">
    ...
    <footer class="bg-gray-200 text-gray-600 py-4 text-center mt-8 border-t border-gray-300">
        <p class="text-sm">© 2024 Microtask. All rights reserved.</p>
    </footer>
</body>
</html>
